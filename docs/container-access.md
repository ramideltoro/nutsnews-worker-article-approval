...
The publish workflow signs and pushes immutable SHA-tagged images. It does not publish mutable `latest` tags. The runtime image runs as the non-root `nutsnews` user.
