...
function approvalDecisionSnapshot() {
  return {
    ...
    title: "A community builds a neighborhood library",
    description: "Residents created a free shared library for local families.",
    imageUrl: "https://example.com/article-001.jpg",
    ...
    qualityScore: 83,
    sourceLanguage: "en",
    sourceSummary: "Residents worked together to create a free neighborhood library for local families.",
